  ...
  return (
    <div className="bg-gradient-to-br from-[#394f68] to-[#18387e] text-white p-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          <Image
            src={`https://www.weatherbit.io/static/img/icons/${weatherCodeInfo.icon}.png`}
            alt={weatherCodeInfo.label}
            width={75}
            height={75}
          />
      ...
      <div className="space-y-2 py-5">
        {results.daily.sunrise?.length > 0 && (
